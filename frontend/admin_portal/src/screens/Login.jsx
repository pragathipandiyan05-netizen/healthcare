...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (hospitalId === 'hospital123' && adminId === 'emp_1' && password === 'password') {
      navigate('/dashboard');
    } else {
      setError('Invalid Hospital ID, Admin ID, or Password.');
    }
  };
      ...
      <Card sx={{ maxWidth: 450, width: '100%', p: 2 }}>
        <CardContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
            <Box sx={{ width: 120, height: 120, display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
