...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontSize: '20px', fontWeight: 600, lineHeight: 1.2, color: '#0F172A' },
    h2: { fontSize: '16px', fontWeight: 600, lineHeight: 1.2, color: '#0F172A' },
    h3: { fontSize: '14px', fontWeight: 600, lineHeight: 1.3, color: '#0F172A' },
    ...
    caption: { fontSize: '11px', fontWeight: 400, lineHeight: 1.4, color: '#64748B' },
