    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            const Padding(padding: EdgeInsets.all(16), child: Text('Available Blood Units', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
            GridView.builder(
              shrinkWrap: true,
                ...
                return Card(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Text(bloodGroups[index], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Colors.red)),
            ...
            const Padding(padding: EdgeInsets.all(16), child: Text('Blood Components', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
            ...
            const Padding(padding: EdgeInsets.all(16), child: Text('Pending Requests', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
            ListView.builder(
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemCount: 3,
