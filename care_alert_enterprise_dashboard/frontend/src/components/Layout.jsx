...
import { 
  ...
  Home, GridView, Menu as MenuIcon
...
export default function Layout({ children }) {
  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: 'background.default', pb: isMobile ? '70px' : 0 }}>
          ...
          <Toolbar sx={{ justifyContent: 'space-between', px: { xs: 2, md: 3 }, height: { xs: 60, md: 76 } }}>
            ...
            {isMobile && (
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Box sx={{ width: 32, height: 32, borderRadius: 1.5, bgcolor: 'primary.main', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        <Box sx={{ width: 'auto', role: 'presentation' }} onClick={() => setMobileMoreOpen(false)} onKeyDown={() => setMobileMoreOpen(false)}>
          ...
          <Typography variant="h4" sx={{ px: 3, mb: 1, fontWeight: 700 }}>More Options</Typography>
          <List>
