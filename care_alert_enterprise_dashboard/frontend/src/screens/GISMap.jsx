...
export default function GISMap() {
  ...
  return (
    <Box sx={{ height: 'calc(100vh - 140px)', display: 'flex', gap: 3 }}>
      {/* FILTER PANEL */}
      <Paper elevation={0} sx={{ width: 280, p: 3, borderRadius: 3, border: '1px solid #E2E8F0', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* MAP AREA */}
      <Paper elevation={0} sx={{ flexGrow: 1, borderRadius: 3, border: '1px solid #E2E8F0', position: 'relative', bgcolor: '#E2E8F0', overflow: 'hidden' }}>
